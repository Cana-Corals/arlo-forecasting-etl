...
.sec-lbl {{ font-size:18px; font-weight:600; letter-spacing:.2em; text-transform:uppercase; color:var(--arlo-muted); white-space:nowrap; }}
...
.pt {{ font-size:18px; font-weight:600; letter-spacing:.16em; text-transform:uppercase; color:var(--arlo-muted); margin-bottom:2px; }}
