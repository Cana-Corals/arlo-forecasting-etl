...
.rm-sub    { font-size:22px; color:var(--muted); }
...
.rm-live-dates { font-size:20px; color:rgba(245,245,240,0.5); }
...
if not rt_w.empty:
    ...
    for idx, r in rt_agg.iterrows():
        ...
        rows_html += (
            ...
            f'<div style="font-size:22px;color:#f5f5f0;white-space:nowrap;overflow:hidden;'
    ...
    with _ra:
        st.markdown(
            ...
            f'<div style="font-size:20px;color:rgba(245,245,240,0.35);margin-bottom:14px;">'
    ...
    with _rb:
        ...
        st.markdown(
            ...
            f'<div style="font-size:20px;color:rgba(245,245,240,0.6);line-height:1.7;">'
    ...
    st.markdown(
        '<div style="padding:0 20px;font-size:20px;color:rgba(245,245,240,0.4);">'
